...
def filter_detections(
    ...
    def _filter_detections(scores, labels):
        ...
        if nms:
            ...
            # perform NMS
            nms_indices = tensorflow.image.non_max_suppression(filtered_boxes, filtered_scores,
    ...
    labels = indices[:, 1]
    scores, top_indices = tensorflow.nn.top_k(scores,
    ...
    other_ = [tensorflow.pad(o, [[0, pad_size]] + [[0, 0] for _ in range(1, len(o.shape))], constant_values=-1) for o in
              other_]
